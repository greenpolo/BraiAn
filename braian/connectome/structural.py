...
class StructuralConnectome(Connectome):
    def __init__(self, normalized_connection_density_file: str,
        ...
        self.A = self.__read_adjacency_matrix(normalized_connection_density_file, regions, brain_ontology, mode, name)
    ...
    def __read_adjacency_matrix(self, normalized_connection_density_file: str,
        ...
        return ConnectomeAdjacency(A=normalized_connection_density, brain_ontology=brain_ontology, name=name)
